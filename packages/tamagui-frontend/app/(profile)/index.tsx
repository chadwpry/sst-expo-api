...
export default function ProfileScreen() {
  ...
  return (
    <View alignItems="center" backgroundColor="#ffffff" justifyContent="center" h="100%" w="100%">
      ...
      <Button borderWidth="1" backgroundColor="transparent" borderColor="#dedede" fontSize="$6" mt="$14" onPress={() => navigateToProfileEdit()}>
        Edit Profile
      </Button>

      <Button borderWidth="1" backgroundColor="transparent" borderColor="#dedede" fontSize="$6" iconAfter={isLoading ? <Spinner color="$orange10" /> : Lock} mt="$4" onPress={() => handleLogout()}>
        Logout
      </Button>
    </View>
  );
